...
public class Adapter_reserva_admin extends RecyclerView.Adapter<Adapter_reserva_admin.ViewHolder> {
     ...
     */
    Adapter_reserva_admin(Context context, List<Reserva> data){
    ...
    @NonNull
    @Override
    public Adapter_reserva_admin.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull Adapter_reserva_admin.ViewHolder viewHolder, int i) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        TextView nombre_chef, nombre_usuario, fecha_reserva, comentario_resenya;
